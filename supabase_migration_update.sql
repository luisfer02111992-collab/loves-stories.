...
-- =========================================================
-- Corrección: al quitar una unidad de un producto que vino del catálogo
-- público, se le devuelve esa cantidad a catalog_products.stock_available
-- (antes solo se devolvía al inventario real, el catálogo se quedaba corto).
